...
public:
  ...
  /* [Luan van - M5] he so nhan tam thoi cho lambda9 (1 = day du, 0 = tat f_d) */
  void setDynScale(const double& s);
  void optimize();
...
private:
  ...
  double dyn_scale_;              // [Luan van - M5] he so nhan tam thoi cho lambda9
